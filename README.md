...
The web is designed to that people with disabilites can access them. 

2. Talk about 3 different things you can do to ensure your website is accessible. 
semantic html, completing all alt tags on images, make sure the website is responsive. 

3. How would you explain the concept of a variable to someone new to programming?
variables are naming conventions that can hold data value. 

4. What is the purpose of using functions in code?
used to avoid repitition of commands, also creates logical structure - breaking up the code into a number of obvious purposes. 
